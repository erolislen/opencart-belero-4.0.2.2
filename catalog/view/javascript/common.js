  ...
  $.ajax({
    ...
    success: function (json) {
      ...
      if (typeof json["error"] == "string") {
        ...
        Swal.fire({icon: "error",toast:true,timer:3000,title: json["error"],showConfirmButton: false,showCloseButton: true,position: "top-end",});
      ...
      if (typeof json["error"] == "object") {
        ...
        //       ' <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>'
        //   );
        Swal.fire({icon: "error",toast:true,timer:3000,title: json["error"]['warning'],showConfirmButton: false,showCloseButton: true,position: "top-end",});
      ...
      if (json["success"]) {
        ...
        Swal.fire({icon: "success",toast:true,timer:3000,title: json["success"],showConfirmButton: false,showCloseButton: true,position: "top-end",});
